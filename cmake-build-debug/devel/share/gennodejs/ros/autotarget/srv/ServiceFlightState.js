...
class ServiceFlightStateRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ServiceFlightStateRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ServiceFlightStateRequest
    let len;
    let data = new ServiceFlightStateRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ServiceFlightStateRequest(null);
...
class ServiceFlightStateResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.state = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ServiceFlightStateResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ServiceFlightStateResponse
    let len;
    let data = new ServiceFlightStateResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ServiceFlightStateResponse(null);
...
module.exports = {
  Request: ServiceFlightStateRequest,
  Response: ServiceFlightStateResponse,
  md5sum() { return '6aae9ff3d63c0cb1e9cd74c840bff68a'; },
  datatype() { return 'autotarget/ServiceFlightState'; }
};
